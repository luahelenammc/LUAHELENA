...
for(const e of publicEntries){
 ...
 const prose=e.body_markdown.replaceAll('Me tornando eu mesma',''); if(/\b(eu|meu|minha|meus|minhas)\b/i.test(prose))errors.push(e.id+' uses first-person singular in article body');
